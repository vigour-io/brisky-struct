...
import { removeContext as remove } from './remove'
...
const contextProperty = (t, val, stamp, key, property) => {
  if (val === null) {
    console.log('(context) NEEDS TO HANDLE SOME STUFF IN EMIT')
    remove(t, key, stamp)
    t[key] = void 0 // not null -- used everywhere else :/ or are we going to use void 0 everywhere?
