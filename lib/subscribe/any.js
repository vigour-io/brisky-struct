...
module.exports = (t, subs, cb, tree, referenced, removed) => {
...
const single = (key, i, $m, t, subs, cb, branch) => {
  ...
  if ($m[i] !== k.tStamp || 0) {
    if (item(key, t, subs, cb, branch, void 0, void 0)) {
      $m[i] = branch[key].$
      return true
    }
  }
...
const modify = (hot, $keys, $m, t, subs, cb, branch) => {
  for (let i = 0, len = hot.length; i < len - 3; i += 4) {
    ...
    if (remove) {
      ...
      item(remove, t, subs, cb, branch, void 0, true)
    ...
    if (create) {
      ...
      item(create, t, subs, cb, branch, void 0, void 0)
      $keys[index] = create
