...
const extractListeners = (t, instance, result) => {
...
const createSetObj = (t, top, instance) => {
  // needs to handle instances
  const result = {}
  const keys = t._ks
  if (t.type && !top) result.type = t.type.compute()
  extractListeners(t, instance, result)
  if (keys) {
...
const merge = (t, type, stamp, reset) => {
  ...
  const instance = create(result, void 0, stamp, t._p, t.key)
  set(
    instance,
    t._ks || t.val !== void 0
    ? !reset
