...
const createType = (parent, val, t, stamp) => {
  ...
  // maybe with context but not sure yet
  // if (!val.reset && (t._ks || t.val !== void 0)) {
  //   // this is different ofc...
  //   // maybe dont do it if its the default very unclear
  //   const raw = createSetObj(t, true, instance)
  //   set(instance, raw, stamp)
  // }
  return instance
}
