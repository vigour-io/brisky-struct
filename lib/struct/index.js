...
const parse = (t, val, key, stamp, props) => {
  if (val === true) {
    ...
    const definition = (t, val, key, stamp, isNew) => property(t, val, key, stamp, struct, isNew)
