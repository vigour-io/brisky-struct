...
test('context - apply and resolve', t => {
  ...
  t.equal(a._c, base2, 'context on "a"')
  obj.get([ 'a', 'b', 'c' ])
  t.equal(a._c, null, 'no context on "a" after reference base')
  var val = c.applyContext(context)
  t.equal(val, void 0, 'applyContext returns undefined when nothing is changed')
  t.equal(a._c, base2, 'c ontext on "a" after applying context')
  t.equal(b._c, base2, 'context on "b" after applying context')
  t.equal(c._c, base2, 'context on "c" after applying context')
  base2.get('a').set('its my own')
  t.equal(obj.a._c, null, 'no context on "a" after resolve')
  val = c.applyContext(context)
  t.equal(val, c, 'applyContext returns base when something is changed')
  t.equal(a._c, null, 'no context on "a" after applying context after resolve')
  t.equal(b._c, base2.a, 'context on "b" after applying context')
  t.equal(c._c, base2.a, 'context on "c" after applying context')
  t.equal(base2.a._c, void 0, 'no context on "base2.a" after applying context')
  ...
  t.equal(val, c, 'applyContext returns base when something is changed')
  t.equal(a._c, null, 'no context on "a" after applying context after resolve')
  t.equal(b._c, null, 'no context on "b" after applying context')
  t.equal(c._c, base3.a.b, 'context on "c" after applying context')
  t.equal(base3.a._c, void 0, 'no context on "base3.a" after applying context')
...
test('context - apply and resolve (double) - simple resolve', t => {
  ...
  t.equal(instance.get(['a', 'b', 'c'])._c, null, 'dont restore context on a resolved field')
  t.end()
})
