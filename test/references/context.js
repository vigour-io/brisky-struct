...
test('references - multi branch origin', t => {
  ...
  branch1.get(['pointers', 'pointer2']).origin().set({ real: { other: 1 } })
  branch2.get(['pointers', 'pointer2']).origin().set({ other: 2 })
  branch3.get(['pointers', 'pointer2']).origin().set({ real: { other: 3 } })
